...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency 'railties', '>= 3.0', '~> 4.0.0.beta1'
  gem.add_dependency 'coffee-rails', '>= 3.2', '~> 4.0.0.beta1'
  gem.add_dependency 'sass-rails', '>= 3.2', '~> 4.0.0.beta1'

  gem.add_development_dependency 'bundler', '>= 1.0'
  gem.add_development_dependency 'rails', '>= 3.0', '~> 4.0.0.beta1'
